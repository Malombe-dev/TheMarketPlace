...
const Navbar = () => {
  ...
  <div className="container-fluid flex-column align-items-start">
    ...
    <div className="d-flex flex-wrap justify-content-center gap-3 w-100">
      ...
      <Link to="/browse-products" className="nav-link text-white d-flex flex-column align-items-center">
        <FaBoxOpen size={20} />
        <span className="d-none d-sm-inline">Products</span>
      </Link>

      <Link to="/browse-skills" className="nav-link text-white d-flex flex-column align-items-center">
        <FaTools size={20} />
      ...
      {isAuthenticated ? (
        <>
          <Link to="/upload-product" className="nav-link text-white d-flex flex-column align-items-center">
            <FaPlusCircle size={20} />
            <span className="d-none d-sm-inline">Upload Product</span>
          </Link>

          <Link to="/upload-skill" className="nav-link text-white d-flex flex-column align-items-center">
            <FaLightbulb size={20} />
            <span className="d-none d-sm-inline">Upload Skill</span>
          </Link>

          <Link to="/profile" className="nav-link text-white d-flex flex-column align-items-center">
            <FaUser size={20} />
            <span className="d-none d-sm-inline">Profile</span>
          </Link>

          <Link to="/messages" className="nav-link text-white d-flex flex-column align-items-center position-relative">
            <FaEnvelope size={20} />
        ...
        <>
          <Link to="/login" className="nav-link text-white d-flex flex-column align-items-center">
            <FaSignInAlt size={20} />
            <span className="d-none d-sm-inline">Login</span>
          </Link>

          <Link to="/signup" className="nav-link text-white d-flex flex-column align-items-center">
            <FaUserPlus size={20} />
